...
String str[];
String aqstr[];
	ResultSet rs=(ResultSet)session.getAttribute("marketOrderResultSet");
	List<String[]> productNames=(List<String[]>)session.getAttribute("productNames");
	List<String> customerNames=(List<String>)session.getAttribute("customerNames");
...
%>
	...
	<input type="hidden" value=<%=rs.getInt(1) %> name=<%="orderId" %> />
	<input type="submit" value="Accept">
	<input type="submit" value="Reject" onclick="form.action='rejectOrder';">
	</form>
<%
		out.print("</tr>");
		j++;
